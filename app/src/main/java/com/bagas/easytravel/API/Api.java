package com.bagas.easytravel.API;
...
public class Api {
    ...
    public static String DetailKuliner = "https://dev.farizdotid.com/api/purwakarta/kuliner/";
    ...
    public static String DetailWisata = "https://dev.farizdotid.com/api/purwakarta/wisata/";
